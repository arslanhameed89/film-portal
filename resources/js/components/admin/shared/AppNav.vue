<template>
    <v-navigation-drawer fixed app :permanent="$vuetify.breakpoint.mdAndUp" light
                         :mini-variant.sync="$vuetify.breakpoint.mdAndUp && mini" :clipped="$vuetify.breakpoint.mdAndUp"
                         :value="mini" :width="300">
        <v-list class="py-0">
            <v-list-item>
        ...
        methods: {
            ...
            navigation() {
                this.items = [
                    ...
                    [
                        {title: 'Create Film', icon: 'person', to: {name: 'create-film'}, exact: false}
                    ],
                    [
                        {title: 'Films', icon: 'person', to: {name: 'films-user'}, exact: false}
                    ],
                    [
